# Generated by Django 3.0.3 on 2020-04-30 17:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumbnail', models.ImageField(blank=True, null=True, upload_to='property_images')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('start_date', models.DateField(help_text='<em>YYYY-MM-DD</em>.', null=True)),
                ('end_date', models.DateField(help_text='<em>YYYY-MM-DD</em>.', null=True)),
